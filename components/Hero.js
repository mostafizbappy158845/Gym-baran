...
import CaretCircleRight from '../public/assets/CaretCircleRight.png';
import PlayCircle from '../public/assets/PlayCircle.png';
        ...
        <section className=''>
            ...
            <div className="bg-gradient-to-t from-purple-50 via-purple-50 to-purple-50 bg-opacity-5 flex flex-col md:flex-row items-center justify-center  px-6 md:px-12   lg:pt-20">
                <div className=' px-12 pt-[120px] md:pt-[200px] flex flex-col   md:w-1/2'>
                    ...
                    <div className="flex ">
                            <button className=" p-4 lg:w-[220px] w-[170px] md:w-[206px] flex items-center justify-around md:px-2 sm:px-8   rounded-[10px]  text-white bg-[#264373]">
                                <p>Get Started</p>
                                ...
                                <Image className='w-6 h-6' src={CaretCircleRight} alt=''></Image>

                            </button>
                            <button className="lg:w-[160px] w-[120px]  flex items-center justify-around  ml-[35px]  rounded-[10px]  text-[#264373] shadow-lg shadow-[0px 14.2857px 57.1429px rgba(51, 78, 123, 0.3)] bg-[#fff]">
                                {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 11.672a.375.375 0 010 .656l-5.603 3.113a.375.375 0 01-.557-.328V8.887c0-.286.307-.466.557-.327l5.603 3.112z" />
                                </svg> */}
                                
                                <Image className='w-6 h-6' src={PlayCircle} alt=''></Image>
