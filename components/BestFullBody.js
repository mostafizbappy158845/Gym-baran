    ...
    return (
        <section className="mx-[100px] my-[120px]">
            <div className="max-w-[1241px] grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-10 ">
                <div className="min-w-[241px] min-h-[287px]">
                ...
                <div className="  grid grid-cols-1 py-10">
                    ...
                    <div className="max-w-[553px] text-[#928f8a] sm:text-[12px] md:text-[14px] lg:text-[16px] lg:leading-[28px] md:leading-[26px] sm:leading-[22px] tracking-[.01em]">
